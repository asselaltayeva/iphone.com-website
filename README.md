# Introduction
This project is an Apple iPhone 15 Pro website clone, built using React, Vite, Tailwind CSS, and GSAP. It replicates Apple's product landing page with scroll-based animations and responsive layout. 
